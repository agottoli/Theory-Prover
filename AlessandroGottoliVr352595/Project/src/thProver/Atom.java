...
public class Atom {
    ...
    /**
     * Constructs an atom with given predicate and arguments and set a weight.
     *
     * @param symbol predicate
     * @param args arguments
     * @param weight weight
    ...
    /**
     * Return a tuple for the lexicographical ordering ONLY arguments
     *
     * @return tuple
     */
    ...
    /**
     * Return a multiset for the multiset ordering ONLY arguments
     *
     * @return multiset
     */
    ...
    /**
     * Constructs a new atom from the application of the given substitution to
     * this atom. (Note: apply ' to distinguish variables with equals name (and
     ...
     * @return the new atom if the substitution modify the atom this if the
     * substitution has no effects.
     */
    public Atom applySubstitution(Substitution tau, Map<String, Variable> vars,
            long time) {
        List<Term> argsNuovi = new ArrayList<>();
        for (Term te : args)
